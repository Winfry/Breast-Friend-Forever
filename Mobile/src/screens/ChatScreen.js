// src/screens/ChatScreen.js - Enhanced Version
...
export default function ChatScreen() {
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      const errorMessage = {
        id: Date.now() + 1,
        text: "I'm having trouble connecting right now. Please check your internet connection and try again. Meanwhile, you can explore our resources section for helpful information!",
        isUser: false,
        timestamp: new Date(),
        type: 'error'
      };
      setMessages(prev => [...prev, errorMessage]);
      Alert.alert('Connection Issue', 'Cannot connect to chat service');
    } finally {
      setIsLoading(false);
    }
  };
