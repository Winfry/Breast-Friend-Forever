  ...
  const loadHospitals = async () => {
    try {
      ...
      const enrichedData = Array.isArray(data) ? data.map((hospital, index) => ({
        ...
        waitTime: Math.floor(Math.random() * 30) + 10, // Random wait time
        isOpen: Math.random() > 0.2, // 80% chance of being open
        specialty: getRandomSpecialty(),
        insurance: ['Aetna', 'Blue Cross', 'Medicare', 'Medicaid'][index % 4]
      })) : defaultHospitals;
    ...
    >
      ...
      <View style={styles.detailsGrid}>
        ...
        <View style={styles.detailItem}>
          ...
          <Text style={styles.detailText} numberOfLines={1}>{item.insurance}</Text>
        </View>
      </View>
...
const defaultHospitals = [
  {
    ...
    services: 'Mammography, Ultrasound, Biopsy, Consultation, Support Groups',
  ...
  },
  {
    ...
    address: '456 Health Avenue, Wellness Plaza',
    phone: '+1 (555) 234-5678',
    services: 'Breast Screening, Genetic Testing, Nutrition Counseling, Mental Health',
    hours: 'Mon-Fri: 7AM-7PM, Sat-Sun: 9AM-4PM',
    specialty: 'Women Health Specialist',
    insurance: 'Blue Cross, Medicaid, Cigna',
    rating: 4.8,
    waitTime: 25,
    isOpen: true
  },
  {
    ...
    address: '789 Care Boulevard, Hope Square',
    phone: '+1 (555) 345-6789',
    services: 'Mammography, Early Detection, Education, Community Outreach',
    hours: 'Mon-Sun: 24/7 Emergency, Screening: 8AM-8PM',
  ...
  {
    id: 4,
    name: 'Hope Oncology Institute',
    address: '321 Hope Street, Medical Complex',
    phone: '+1 (555) 456-7890',
    services: 'Oncology, Radiation, Chemotherapy, Surgical Oncology, Rehabilitation',
    hours: 'Mon-Fri: 7AM-9PM, Sat: 8AM-2PM',
    specialty: 'Oncology Center',
    insurance: 'Medicare, Aetna, United Health',
    rating: 4.9,
    waitTime: 20,
    isOpen: false
  }
