    ...
    with st.container():
            ...
            <div class="{card_class}">
                ...
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    <div style="color: #888; font-size: 0.9rem;">
                        ...
                        <span style="margin-left: 1rem;">⏱️ {article['reading_time']}</span>
                    </div>
                </div>
            </div>
        """, unsafe_allow_html=True)
        ...
        with col1:
            if completed:
                ...
                if st.button(f"📖 Read Article", key=f"read_article_{article['id']}"):
            ...
            <div class="resource-card pdf-card">
                ...
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    <div style="color: #888; font-size: 0.9rem;">
                        ...
                        <span style="margin-left: 1rem;">📖 {pdf['pages']} pages</span>
                    </div>
                </div>
            </div>
        """, unsafe_allow_html=True)
        
        if st.button(f"⬇️ Download PDF", key=f"pdf_{pdf['id']}"):
...
for link in resources["external_links"]:
    ...
    with st.container():
        ...
        if st.button(f"🌐 Visit Resource", key=f"link_{link['id']}"):
