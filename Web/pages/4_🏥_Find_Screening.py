...
def load_hospital_data():
    try:
        ...
        if os.path.exists(csv_path):
            ...
            # Removed file path from success message
        else:
            st.warning(f"⚠️ CSV file not found. Using sample data.")
            return None, None
...
if hospital_df is not None:
    ...
    clinics_data = [
        ...
        {
            "id": 2, "name": "Aga Khan University Hospital", "type": "National Hospital", "county": "Nairobi",
            "distance": 4.1, "rating": 4.9, "reviews": 189, "address": "3rd Parklands Avenue, Nairobi",
            "phone": "+254 20 366 2000", "emergency": "+254 711 709 100",
            "insurance": ["NHIF", "Madison", "Jubilee", "AAR", "CIC", "Britam"],
            "languages": ["Swahili", "English", "Hindi", "Gujarati"], "wait_time": "3-5 Days",
            ...
            "status": "premium", "price_range": "$$$", "hours": "Mon-Sun: 6AM-10PM",
            "specialty": "State-of-the-art diagnostic imaging and comprehensive cancer care",
            "lat": -1.2542, "lon": 36.8134
        },
        {
            "id": 3, "name": "Mombasa Women's Hospital", "type": "County Hospital", "county": "Mombasa",
            "distance": 0.8, "rating": 4.5, "reviews": 156, "address": "Nyerere Avenue, Mombasa",
            "phone": "+254 41 222 3851", "emergency": "+254 722 516 363",
            "insurance": ["NHIF", "Jubilee", "Private Pay", "Comprehensive Care"],
            "languages": ["Swahili", "English", "Digo", "Duruma"], "wait_time": "Same day",
